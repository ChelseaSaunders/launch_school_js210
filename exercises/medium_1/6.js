...
// This simple sequence can easily be computed using a recursive function. A
// recursive function is one in which the function calls itself. For example,
...
//   - It has an ending condition — e.g., if (n === 1), in the sum function
//     above.
//   - The results of each recursion are used in each step — e.g.,
//     n + sum(n - 1) uses sum(n - 1).
